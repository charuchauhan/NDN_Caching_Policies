...
main(int argc, char* argv[])
{
  ...
  ndn::L3RateTracer::InstallAll("L3_rate_tree_trace-sprob.txt", Seconds(0.5));
  L2RateTracer::InstallAll("L2_rate_tree_trace-sprob.txt", Seconds(0.5));
  ndn::CsTracer::InstallAll("cs-hit-tree_trace-sprob.txt", Seconds(0.5));
  ndn::AppDelayTracer::InstallAll("app-delays-tree-sprob-trace.txt");
  Simulator::Run();
  Simulator::Destroy();
