...
main(int argc, char* argv[])
{
  ...
  ndn::L3RateTracer::InstallAll("L3_rate_tree_trace-lcd.txt", Seconds(0.5));
  L2RateTracer::InstallAll("L2_rate_tree_trace-lcd.txt", Seconds(0.5));
  ndn::CsTracer::InstallAll("cs-hit-tree_trace-lcd.txt", Seconds(0.5));
  ndn::AppDelayTracer::InstallAll("app-delays-tree-lcd-trace.txt");
  Simulator::Run();
  Simulator::Destroy();
