...
main(int argc, char* argv[])
{
  ...
  /****************************************************************************/
  // Tracer:
 ndn::L3RateTracer::InstallAll("L3_rate_tree_trace.txt", Seconds(0.5));
  L2RateTracer::InstallAll("L2_rate_tree_trace.txt", Seconds(0.5));
 ndn::CsTracer::InstallAll("cs-hit-tree_trace.txt", Seconds(1));
 ndn::AppDelayTracer::InstallAll("app-delays-tree-trace.txt");
  Simulator::Run();
  Simulator::Destroy();
